...
> **Registro histórico** (junio 2026). Snapshot de los grids phase 2 en simulación
> (COBYLA vs QNSPSA). Los paths de scripts y nombres de arquitectura reflejan el
> estado del repo en esa fecha.
...
**Figuras** (abrir en lateral desde `docs/../../../report-assets/phase2-ideal-shot-noise/`):
...
| Early stopping | Eliminado; parada solo por budget (`BudgetExceeded`)              |
