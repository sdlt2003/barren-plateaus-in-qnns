...
> **Registro histórico** (junio 2026). Estado del grid IBM en esa fecha; budgets,
> rutas de scripts y pendientes pueden no coincidir con el pipeline actual (phase 3).
...
- Budget: [`logic.md`](../../../logic.md) (valores actuales; este informe usa la política de junio 2026)
- Ideal + shot-noise (completado): [`report-phase2-ideal-shot-noise.md`](report-phase2-ideal-shot-noise.md)
- Launcher HW (histórico): `src/phase2/sbatches/exp-real.sbatch` → hoy `src/sbatches/exp-real.sbatch`
